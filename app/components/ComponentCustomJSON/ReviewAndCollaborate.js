...
export default function ReviewAndCollaborate() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#061016] text-white py-24">
      ...
      <h2 className="text-4xl font-bold text-[#0AB5A9]">Review & Collaborate</h2>
      ...
      <div className="w-full max-w-[900px] mt-12 rounded-xl overflow-hidden shadow-lg border border-[#0AB5A9]/30">
        <Image src="/images/review&collobarate.webp" alt="Review" width={900} height={500} className="w-full h-auto object-cover" />
      </div>
    </div>
  );
}
